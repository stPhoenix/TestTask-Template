...
namespace CSharpTest
{
    ...
    public class WorkDayCalculatorTests
    {
        ...
        [TestMethod]
        public void TestSeveralWeekends()
        {
            DateTime startDate = new DateTime(2017, 4, 21);
            int count = 5;
            WeekEnd[] weekends = new WeekEnd[2]
            {
                new WeekEnd(new DateTime(2017, 4, 23), new DateTime(2017, 4, 25)),
                new WeekEnd(new DateTime(2017, 4, 27), new DateTime(2017, 4, 30))
            };
        ...
        [TestMethod]
        public void TestWeekendAtStart()
        {
            DateTime startDate = new DateTime(2017, 4, 17);
            int count = 4;
            WeekEnd[] weekends = new WeekEnd[1]
            {
                new WeekEnd(new DateTime(2017, 4, 17), new DateTime(2017, 4, 17))
            };
